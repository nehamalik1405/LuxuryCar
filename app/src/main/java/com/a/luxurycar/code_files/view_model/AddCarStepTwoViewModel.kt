...
class AddCarStepTwoViewModel(val repository: AddCarStepTwoRepository):BaseViewModel(repository) {
   ...
   /* private val _getAddCarStepTwoResponse: MutableLiveData<Resource<AddCarStepThreeListingPlanModel>> = MutableLiveData()
    val getAddCarStepTwoResponse: LiveData<Resource<AddCarStepThreeListingPlanModel>>
...
*/
    fun getAddSellerListingPlan(id:String) = viewModelScope.launch {
       ...
       /* _getAddCarStepTwoResponse.value = Resource.Loading
        _getAddCarStepTwoResponse.value = */
            repository.getAddCarStepTwoResponse(id)
