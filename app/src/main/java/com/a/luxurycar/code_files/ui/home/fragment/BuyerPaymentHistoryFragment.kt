...
import com.a.luxurycar.databinding.FragmentBuyerPaymentHistoryBinding


class BuyerPaymentHistoryFragment : BaseFragment<PaymentHistoryViewModel,FragmentBuyerPaymentHistoryBinding,PaymentHistoryRepository>() {
    override fun getViewModel()=PaymentHistoryViewModel::class.java

    override fun getFragmentBinding(
        inflater: LayoutInflater,
        container: ViewGroup?,
    ) = FragmentBuyerPaymentHistoryBinding.inflate(inflater,container,false)
