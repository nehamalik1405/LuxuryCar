...
data class RelatedListings(
    @SerializedName("body_condition")
    val bodyCondition: Any,
    ...
    val carImages: List<CarImageX>,
    @SerializedName("car_model")
    val carModel: CarModelX,
